...
\address{Schäftlarnstr. 104}{81371 Munich}{Germany}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\section{Software Skills}
  \cvitem{Javascript}{
    ...
    \href{https://github.com/inakianduaga/react-redux-typescript/tree/develop}{\textbf{ReactJS}} \href{https://github.com/inakianduaga/redux-state-history}{\textbf{(w/ redux pattern)}},
  ...
  \cvitem{Other}{
    ...
    HTML5,
    Bootstrap,
    \textbf{\href{https://gist.github.com/inakianduaga/ef2220f975d8fe6aa88d}{Perl}} (tiny bit),
  ...
  \cvitem{API}{
    Rest,
    \textbf{\href{https://www.tado.com/shop/api/public/v1/api-docs}{Swagger}},
    OAuth.
  }
...
\section{Professional Experience}
  ...
  %\subsection{Professional}
    ...
    \cventry{2013 - Now}{Full Stack Developer}{\href{https://www.tado.com}{tado gmbh}}{Munich, Germany}{}{\\
      In charge of developing and maintaining the entire frontend \& backend of the main \href{https://www.tado.com}{tado.com} website, plus an internal dashboard/order management system used by customer support to handle the online shop. In addition, I manage the entire website content lifecycle, including CI infrastructure, AWS EC2 server setup/provisioning, database migrations/backups, code deployments, logging, performance tuning, etc.\newline{}%
      Some of the tasks I frequently do:%
      \begin{itemize}%
        \item Upgrading all dev \& production software stacks (incl packages and tooling).
        \item Management of the entire deployment pipeline (incl. daily continuous deployments).
        \item Adding functionality and improving the AngularJS-based webshop.
        \item Implementing advanced backend features to support the complex website structure (external SDKs, multilanguage support, order invoicing, user accounts, etc).
      \end{itemize}}

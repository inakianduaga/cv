...
engineer working on solving practical problems in the most efficient and clean way. Although different problems require different tools, the underlying thinking
...
the overall approach is always the same,  with the same approach as before,
